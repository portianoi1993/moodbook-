...
// Sound mode has no genre profiles: these ambiences fit any book, and the AI supplies
// book-specific ones whenever it is available.
const SOUNDS = ['Rain and Distant Thunder', 'Crackling Fireplace', 'Ocean Waves at Night', 'Forest After Dark', 'Busy Tavern'];
const SOUND_TRACKS = [
  ['Rain and Thunder', 'rain · rumble', 'heavy rain and distant thunder ambience 1 hour no music'],
  ['Crackling Fireplace', 'fire · warm', 'crackling fireplace ambience 1 hour no music'],
  ['Ocean at Night', 'waves · slow', 'ocean waves at night ambience 1 hour no music'],
  ['Forest After Dark', 'wind · crickets', 'night forest ambience crickets wind 1 hour no music'],
  ['Busy Tavern', 'crowd · fire', 'medieval tavern ambience crowd fireplace 1 hour no music'],
  ['Wind Over Open Country', 'wind · vast', 'howling wind ambience 1 hour no music'],
];
...
export function composeOffline({ title, author, genre, desc, mood, style, sound }) {
  ...
  const source = sound ? SOUND_TRACKS : prof.tracks;
