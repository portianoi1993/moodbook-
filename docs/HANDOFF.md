...
- Free = **3 повні книги назавжди** (не на день); книги з полиці граються безкоштовно; далі Pro. Ціни затверджено 7.09.2026 (docs/PRICING.md): $9.99/міс, **$59.99/рік** (за замовчуванням), Founding Reader $79 довічно для перших 100; для української локалі ₴249 / ₴1 490 / ₴1 990. Обіцянок про синхронізацію в Pro немає до Supabase.
